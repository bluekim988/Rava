...
/*
  	자바 프로그램의 토큰 구분
  		...
  		예]
  			int a = 10
  			int b = 20;
  				==> 컴파일러는 위의 두줄을 하나의 명령으로 간주해서 처리할 것이고
  					이런 명령의 형식은 자바에서는 존재하지 않으므로 
  					에러가 발생하게 된다.
  					
  		예]
  			int a = 10; int b = 20;
  				==> 한줄로 입력했지만
  					두개의 명령을 토큰으로 구분해주었기 때문에 각각을 인식해서 컴파일 할 수 있다.
...
//		예제] 숫자를 입력받아서 입력받은 수에서 50 뺀 수를 출력하자.
//		1.  입력받을 준비
		Scanner sc = new Scanner(System.in);
//		2.	메세지 출력
...
//		5.	변환된 정수를 계산한다.
		int result = num - 50;
//		6.	계산 결과를 출력한다.
		System.out.println("입력한 수 " + num + " 에서 50 을 빼면 " + result + " 입니다.");
	}
